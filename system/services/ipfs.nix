  ...
  services.kubo = {
    ...
    settings = {
      Addresses = {
        ...
        # Announce = [ "/ip4/<your-public-ip>/tcp/2002" "/ip4/<your-public-ip>/udp/1003/quic-v1" ];
        # NoAnnounce = [ ];
      };
      ...
      API = {
        HTTPHeaders = {
          "Access-Control-Allow-Origin" = ["http://127.0.0.1:2005" "http://127.0.0.1:1006" "*"];
      ...
      Gateway = {
        ...
        RootRedirect = "/webui"; # uncomment if you want 2006/ to jump to the WebUI
      };
    };
  };
}
